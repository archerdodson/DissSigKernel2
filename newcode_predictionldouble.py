...
#####################################################################
batch_size, ensemble_size, method, nn_model, data_size, auxiliary_var_size = 1000, 3, 'SR', 'rnn', 8, 1 #mess around with model size
...
model, scoring_rule = 'lorenz96', 'SignatureKernel' #Doesn't matter?
cuda, continue_training_net, start_epoch_early_stopping, use_tqdm, method_is_gan  = True, False, 100, True, False
...
model, scoring_rule = 'lorenz96', 'EnergyScore' #Doesn't matter?
cuda, continue_training_net, start_epoch_early_stopping, use_tqdm, method_is_gan  = True, False, 100, True, False
